...
Revision ID: b50443a8f342
Revises: None
Create Date: 2016-09-28 07:51:16.656000

"""

# revision identifiers, used by Alembic.
revision = 'b50443a8f342'
down_revision = None
...
def upgrade():
    ...
    op.create_index(op.f('ix_borrowedbooks_status'), 'borrowedbooks', ['status'], unique=False)
    ### end Alembic commands ###


def downgrade():
    ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_borrowedbooks_status'), table_name='borrowedbooks')
